...
class Program {
    ...
    {
        IFactory l1 = Lec03BLib.Lec03BLib.GetL1(); //фабрика 1
        ...
        IFactory l2 = Lec03BLib.Lec03BLib.GetL2(1); //фабрика 2
        ...
        IFactory l3 = Lec03BLib.Lec03BLib.GetL3(1, 0.5f); //фабрика 3
